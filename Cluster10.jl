using JuMP
using Gurobi
log_file_path = "/scratchbeta/clementf/10.txt"
# 2d continuous case, basic model using dummy points, base constraints
...
output_file= open("/scratchbeta/clementf/OC_10.jl", "w")
write(output_file, "x = ")
